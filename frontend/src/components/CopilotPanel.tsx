...
/**
 * Self-contained DigiRaksha AI Cyber Copilot: chat, FIR drafter and rapid
 * scam triage. Reusable as a full-height page (AssistantPage) or embedded in
 * the Analyse section after a scan result.
 */
export function CopilotPanel({ height = "600px" }: { height?: string }): React.ReactElement {
  const { t } = useI18n();
