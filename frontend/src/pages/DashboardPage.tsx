...
const RISK_COLORS: Record<string, string> = { low: "#34d399", medium: "#fbbf24", high: "#f87171" };
const STATUS_COLORS: Record<string, string> = { open: "#0d9488", investigating: "#d97706", closed: "#db2777" };
    ...
    <div className="page">
      ...
      <div className="grid grid-2" style={{ marginTop: 14 }}>
        <div className="card">
          ...
          <div className="chart-sub">{t("dash.stat.scans")}</div>
          {catData.length === 0 ? (
        ...
        <div className="card">
          ...
          {riskData.length === 0 ? (
            ...
            <DonutChart data={riskData} centerLabel={t("dash.stat.scans")} />
          )}
        </div>
      </div>
      ...
      <div className="grid grid-2" style={{ marginTop: 14 }}>
            ...
            <div className="donut-labels">
              {a.cases_by_status.map((s) => (
                <div className="donut-row" key={s.status}>
                  <span className="swatch" style={{ background: STATUS_COLORS[s.status] || "#5c6a7d" }} />
        ...
        <div className="card">
          ...
          <div className="chart-sub">{t("dash.stat.high7")}: {a.stats.high_risk_7d}</div>
                ...
                <div className="ev-row" key={s.scan_id}>
                  ...
                  <div className="ev-main">
                    ...
                    <div className="ev-meta">
                      {fmtDate(s.created_at)} · {s.media_type}
                    </div>
                  </div>
